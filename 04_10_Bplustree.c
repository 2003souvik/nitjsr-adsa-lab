...
typedef struct BPTreeNode {
    ...
    int numKeys;
    int keys[ORDER - 1];
    struct BPTreeNode* children[ORDER];     // for internal nodes
    struct BPTreeNode* next;                // for leaf nodes only
} BPTreeNode;
...
// ----------------------
// insertItem(): Main insert function
// ----------------------
...
// ----------------------
// Print Tree (In-order traversal of leaf level)
// ----------------------
